function AFFICH_m () {
	switch(arguments[0])
	{
		case "define":
			...
			model.dstate = new ScilabDouble([-1],[0],[0],[1],[1],[0],zeros(in1[0]*in1[1],1).splice(0,1));
			model.ipar = new ScilabDouble([font],[fontsize],[colr],[1000],[nt],[nd],[in1[0]]);
			model.blocktype = new ScilabString(["c"]);
			model.firing = new ScilabDouble();
			model.dep_ut = new ScilabBoolean([true,false]);
			model.label = new ScilabString([""]);
			var exprs = new ScilabString([sci2exp([parseFloat(getData(model.in).splice(0,1)),parseFloat(getData(model.in2).splice(0,1))])],[font.toString()],[fontsize.toString()],[colr.toString()],[nt.toString()],[nd.toString()],[(0).toString()]);
